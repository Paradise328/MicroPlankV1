...
int32_t SysdeviceDemo()
{
  ...
  if(CIFX_NO_ERROR == lRet)
  {
    ...
    lRet = xSysdeviceOpen(hDriver, CIFX_DEV_TEST, &hSys);
  ...
  if(CIFX_NO_ERROR == lRet)
  {
    ...
    } else
    {
      ...
      printf("Channel Mailbox State: MaxSend = %u, Pending Receive = %u\r\n",
             ulSendPktCount, ulRecvPktCount);
      tSendPkt.tHeader.ulDest=0x00000000;
      tSendPkt.tHeader.ulCmd=0x00000000;
      /*
