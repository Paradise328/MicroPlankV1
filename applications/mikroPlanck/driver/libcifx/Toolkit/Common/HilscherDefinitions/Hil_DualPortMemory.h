...
***************************************************************************************
  ...
  $Id: Hil_DualPortMemory.h 425 2022-01-04 10:42:40Z RMayer $:
  ...
  Changes:
    Date        Description
    -----------------------------------------------------------------------------------
    2022-01-04  Added combined HIL_SYS_CONTROL_RESET_PARAM_FLAG_MASK definition
    2021-06-17  Added new reset flag and reworked reset masks and flags names
