...
#include "../MicroPlank_QTVersion/Modules/RobotControlModule/RobotControl.h"
...
QT_MOC_LITERAL(1, 13, 13), // "DealMsgSignal"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "RobotControl\0DealMsgSignal\0"
};
...
void RobotControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (RobotControl::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RobotControl::DealMsgSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RobotControl::DealMsgSignal()
{
