...
#include "../MicroPlank_QTVersion/Modules/MotorDriverModule/MotorDriver.h"
...
QT_MOC_LITERAL(1, 12, 13), // "DealMsgSignal"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 13), // "SendMsgSignal"
QT_MOC_LITERAL(4, 41, 15), // "Message_Inner_T"
QT_MOC_LITERAL(5, 57, 3) // "msg"

    },
    "MotorDriver\0DealMsgSignal\0\0SendMsgSignal\0"
    "Message_Inner_T\0msg"
};
...
void MotorDriver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->DealMsgSignal(); break;
        case 1: _t->SendMsgSignal((*reinterpret_cast< const Message_Inner_T(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MotorDriver::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MotorDriver::DealMsgSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MotorDriver::*)(const Message_Inner_T );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MotorDriver::SendMsgSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MotorDriver::DealMsgSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MotorDriver::SendMsgSignal(const Message_Inner_T _t1)
{
