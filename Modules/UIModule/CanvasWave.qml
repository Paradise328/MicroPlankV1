...
Canvas {
    ...
    property int fontPx: 38
    property bool fontBold: true
    property color textColor: "#FFFFFF" //文本颜色
    property color waveColor: "#19CAAD" //波浪颜色
    //波浪参数
    property real waveWidth: 0.05   //数越小越宽
    property real waveHeight: 5     //数越大越高
    property real speed: 0.1        //数越大速度越快
    ...
    onPaint: {
        ...
        ctx.lineWidth = 2;
        ctx.strokeStyle = "rgba(54, 240, 151, 0.2)";
        ctx.beginPath();
