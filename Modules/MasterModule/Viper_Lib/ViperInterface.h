/* VSS $Header: /Viper/VPCmdIF/VPCmdIF/Inc/ViperInterface.h 51    6/01/20 3:54p Suzanne $
*/
/**
...
{
    FILTER_TRGT_PNO = 0 /**< Target position and orientation. Can only be used with CMD_ACTION_SET and _RESET. */
...
#define Quaternion_Fract2Float(i_quat)  FractToFloat(i_quat, FFACTOR_QTRN);
